...
public class SubversionService extends Service {
   ...
   * Show log.
   *
   * @param request the show log request
   ...
   * Show diff.
   *
   * @param request the show diff request
   ...
   * Resolve conflicts.
   *
   * @param request the resolve conflicts request
  ...
  public Response exportPath(
      final @PathParam("projectPath") String projectPath,
      final @DefaultValue(".") @QueryParam("path") String path,
      final @QueryParam("revision") String revision)
      throws ApiException, IOException {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces({MediaType.APPLICATION_JSON, MediaType.TEXT_PLAIN})
  public GetRevisionsResponse getRevisions(final GetRevisionsRequest request)
      throws ApiException, IOException {
    request.setProjectPath(getAbsoluteProjectPath(request.getProjectPath()));
   ...
   *
   * @param request the property setting request
   ...
   *
   * @param request the property delete request
